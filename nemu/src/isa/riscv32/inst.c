...
#define INSTBRANCH                                            \
  ...
  INSTPAT("??????? ????? ????? 001 ????? 11100 11", csrrw, CSRw, *csr = src1 & MSTATUS_MASK);
  INSTPAT("??????? ????? ????? 010 ????? 11100 11", csrrs, CSRw, *csr |= src1 & MSTATUS_MASK);
  INSTPAT("??????? ????? ????? 011 ????? 11100 11", csrrc, CSRw, *csr &= ~src1);
  INSTPAT("??????? ????? ????? 101 ????? 11100 11", csrrwi, CSRwi, *csr = imm & MSTATUS_MASK);
  INSTPAT("??????? ????? ????? 110 ????? 11100 11", csrrsi, CSRwi, *csr |= imm & MSTATUS_MASK);
